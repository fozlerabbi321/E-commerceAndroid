    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, @NonNull final Cart model)
            {
                ...
                // get total price all product
               int oneTypeProductTPrice =((Integer.valueOf(model.getPrice()))) * Integer.valueOf(model.getQuantity());
                overTotalPrice = overTotalPrice + oneTypeProductTPrice;
                // itemview click on edit and remove
                    ...
                    public void onClick(View view)
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                ...
                                if (i == 0)
                                {
                                    Intent intent = new Intent(CartActivity.this, ProductDetetailsActivity.class);
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists())
                {
                  ...
                  {
                      txtTotalAmount.setText("Dear "+userName+ "\n orders is shipped successfully");
                      recyclerView.setVisibility(View.GONE);
                      msg1.setVisibility(View.VISIBLE);
                      msg1.setText("Congratulations,your final order has been shipped successfully. Soon you received your order ar your door step.");
                      NextProcessBtn.setVisibility(View.GONE);
                      Toast.makeText(getApplicationContext(), "you can purchase more products, one you received your first final orders.", Toast.LENGTH_SHORT).show();
                      
                  }
                  else if (shippingState.equals("not shipped"))
                  {
                      txtTotalAmount.setText("Shipping state = Not Shipping");
                      recyclerView.setVisibility(View.GONE);
                      msg1.setVisibility(View.VISIBLE);
                      NextProcessBtn.setVisibility(View.GONE);
                      Toast.makeText(getApplicationContext(), "you can purchase more products, one you received your first final orders.", Toast.LENGTH_SHORT).show();
